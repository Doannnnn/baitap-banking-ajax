...
public class CustomerService implements ICustomerService{
    ...
    public List<Customer> findAll(boolean deleted) {
        return customerRepository.findAll().stream().filter(customer -> !customer.getDeleted()).collect(Collectors.toList());
    }
    ...
    public List<Customer> findAllWithoutId(Long id) {
        ...
        List<Customer> filteredCustomers = customers.stream()
                .filter(customer -> !customer.getId().equals(id) && !customer.getDeleted())
